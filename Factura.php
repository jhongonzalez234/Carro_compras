...
$this->Image('img/waves.png',-10,-1,110); // baner al costado izquierdo 
...
function Footer()
{
     $this->SetFont('helvetica', 'B', 8);
        ...
        $this->Cell(0,5,utf8_decode("Almacenes El Ahorro © Todos los derechos reservados."),0,0,"C");
...
$pdf = new PDF();
$pdf->AliasNbPages(); // numeros de pagina
$pdf->AddPage();
...
$pdf->Image('img/apple.png',150,15,25);
